  ...
  >
    {#if resume}
      <div
        ...
        class="absolute inset-0 backdrop-blur bg-slate-900/50 z-10"
      />
      <button
      ...
      >
        ...
        <p class="text-base 2xl:text-2xl">
          ...
          Российский экономический университет&nbsp;им.&nbsp;Плеханова <br /> Специальность:
        ...
        <p class="text-base 2xl:text-2xl">
          Специализируюсь в&nbsp;области налогового права, бухгалтерского учета
