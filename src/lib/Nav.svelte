...
<div
  class="fixed w-full backdrop-blur-sm bg-slate-900/80 border-b border-slate-800 shadow-lg transform ease-in-out transition-all duration-200 {isNav
    ? 'translate-y-0'
...
>
  ...
  >
    ...
    >
      ...
      <div class="text-sm 2xl:text-base leading-4 text-slate-100">
...
>
  <div class="flex flex-col h-full">
    ...
    <div
      class="my-4 flex-shrink-0 text-2xl leading-tigth font-bold text-slate-100"
    >
